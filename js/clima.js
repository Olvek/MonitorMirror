...
export const updateWeather = (lat,lon)=>{
    ...
    fetchData(url.currentWeather(lat,lon),(currentWeather)=>{
        ...
        <div class="weapper">
            ...
            <img src="/img/weather_icons/${icon}.png" width="64" height="64" alt="${description}" class="weather-icon">
        </div>
            ...
            for (const[index,data] of forecastList.entries()){
                ...
                tempLi.innerHTML=`
                    <div class="card card-sm slider-card">
                        ...
                        <img src="/img/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${description}" class="weather-icon" title="${description}">
                ...
                windLi.innerHTML=`
                    <div class="card card-sm slider-card">
                        <p class="body-3">${module.getTime(dateTimeUnix,timezone)}</p>
                        <img src="/img/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${description}" class="weather-icon" style="transform :rotate(${windDirection - 180}deg)">
